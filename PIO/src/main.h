...
SMARTPANEL_GLOBAL char releaseString[] _INIT(SMARTPANEL_RELEASE_NAME); // must include the quotes when defining, e.g -D SMARTPANEL_RELEASE_NAME=\"ESP32_MULTI_USREMODS\"
